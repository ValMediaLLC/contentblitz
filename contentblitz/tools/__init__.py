...
from contentblitz.tools.generate_image import (
    GenerateImageResult,
    generate_image as generate_image_result,
)
from contentblitz.tools.generate_text import (
    GenerateTextResult,
    generate_text as generate_text_result,
)
